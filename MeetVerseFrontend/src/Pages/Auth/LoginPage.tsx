...
export default function LoginPage() {
  ...
  useEffect(() => {
    document.title = "Sign in — MeetVerse";
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/40 dark:bg-none dark:bg-[#0d1117] text-slate-900 dark:text-[#F1F5F9] transition-colors duration-300 font-['Plus_Jakarta_Sans']">
      ...
      <div className="flex min-h-screen relative z-10">
        ...
        {/* Right Panel (Form) */}
        <div className="w-full lg:w-[60%] flex flex-col justify-center px-6 py-10 lg:px-24">
          <div className="w-full max-w-[420px] mx-auto form-card bg-white dark:bg-[#0d1117] lg:bg-transparent lg:dark:bg-transparent border border-slate-200 dark:border-white/10 lg:border-none rounded-3xl p-8 lg:p-0 shadow-xl lg:shadow-none">
