        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeetingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TotalSpeakingTimeSeconds = table.Column<double>(type: "float", nullable: false),
                    ...
                    ScreenShareDurationSeconds = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EngagementMetrics_Meetings_MeetingId",
                        column: x => x.MeetingId,
                        principalTable: "Meetings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EngagementMetrics_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsNoiseCleaned = table.Column<bool>(type: "bit", nullable: false),
                    AverageNoiseLevel = table.Column<double>(type: "float", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WhiteboardSessions_Meetings_MeetingId",
                        column: x => x.MeetingId,
                        principalTable: "Meetings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transcripts_Recordings_RecordingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WhiteboardEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WhiteboardEvents_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WhiteboardEvents_WhiteboardSessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MeetingSummaries_Transcripts_TranscriptId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpeakerLabel = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EngagementMetrics_MeetingId",
                table: "EngagementMetrics",
                column: "MeetingId");

            migrationBuilder.CreateIndex(
                name: "IX_EngagementMetrics_UserId",
                table: "EngagementMetrics",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeetingSummaries_TranscriptId",
                table: "MeetingSummaries",
                column: "TranscriptId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WhiteboardEvents_SessionId",
                table: "WhiteboardEvents",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_WhiteboardEvents_UserId",
                table: "WhiteboardEvents",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_WhiteboardSessions_MeetingId",
